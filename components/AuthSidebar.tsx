...
export default function AuthSidebar() {
    return (
        <div className="relative hidden w-full lg:flex lg:w-1/2 overflow-hidden bg-[#24367A] flex-col justify-center items-center">
            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-between p-12 lg:p-20">
                ...
                <div className="flex-grow flex flex-col justify-center max-w-lg mx-auto w-full mt-10">
                    ...
                    >
                        ...
                        <h1 className="text-4xl lg:text-5xl font-extrabold text-white mb-6 leading-[1.15] tracking-tight drop-shadow-sm">
                            Next-Generation <br />
