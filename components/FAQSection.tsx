      ...
      <div className="container mx-auto max-w-4xl px-4 relative z-10">
        <div className="text-center mb-20">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-semibold text-slate-900 mb-8 tracking-tight leading-tight">
            ...
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`} className="border-b border-slate-100 last:border-0">
                <AccordionTrigger className="hover:no-underline py-8 group">
                  <div className="flex items-center gap-6 text-slate-900 font-semibold text-lg md:text-xl transition-all group-hover:text-[#3A57FC] text-left">
                ...
                <AccordionContent className="text-slate-500 text-base md:text-lg leading-relaxed pl-[76px] pb-10 font-normal">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
