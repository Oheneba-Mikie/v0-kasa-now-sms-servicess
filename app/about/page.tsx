        ...
        <div className="flex flex-col bg-white">
            ...
            <section className="bg-blue-gradient py-24 md:py-32 text-white text-center overflow-hidden relative">
                <div className="container mx-auto max-w-7xl px-4 relative z-10">
                    ...
                    <h1 className="text-5xl font-extrabold md:text-7xl tracking-tighter mb-8 italic">Simplifying communication for all</h1>
            ...
            <section className="py-24 md:py-32">
                <div className="container mx-auto max-w-7xl px-4">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-4xl font-extrabold text-[#1E3A8A] mb-8 tracking-tight">Bridging the gap in <span className="text-blue-gradient italic">digital communication</span></h2>
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    <h4 className="text-4xl font-black text-blue-600 tabular-nums tracking-tighter">500M+</h4>
                                    <p className="text-sm font-bold text-gray-400 uppercase tracking-widest">Messages Delivered</p>
                                </div>
                                <div className="space-y-4">
                                    <h4 className="text-4xl font-black text-blue-600 tabular-nums tracking-tighter">10K+</h4>
                        ...
                        <div className="bg-gray-100 rounded-[56px] p-2 aspect-square relative overflow-hidden shadow-2xl">
                            <div className="w-full h-full rounded-[48px] bg-white flex items-center justify-center p-12">
                                ...
                                <div className="relative z-10 text-center space-y-8">
                                    ...
                                    <h3 className="text-2xl font-bold text-[#1E3A8A]">Ghana's Preferred SMS Platform</h3>
            ...
            <section className="bg-gray-50 py-24 md:py-32 border-y border-gray-100">
                <div className="container mx-auto max-w-7xl px-4 text-center">
                    <h2 className="text-4xl font-black text-[#1E3A8A] mb-20 italic">The values that drive us</h2>
                    <div className="grid gap-12 md:grid-cols-3">
                        {[
                            ...
                            <div key={i} className="p-10 bg-white rounded-[40px] shadow-sm hover:shadow-xl transition-shadow border border-gray-100 text-left group">
                                ...
                                <h3 className="text-2xl font-bold text-[#1E3A8A] mb-4">{v.title}</h3>
            ...
            <section className="py-24 md:py-32">
                <div className="container mx-auto max-w-5xl px-4 text-center">
                    <div className="space-y-8 mb-20">
                        <h2 className="text-4xl font-extrabold text-[#1E3A8A]">Join our mission</h2>
                    ...
                    <div className="bg-blue-gradient p-12 md:p-20 rounded-[56px] text-white shadow-2xl">
                        <h2 className="text-4xl font-black mb-8 italic tracking-tighter">Build with KasaNow</h2>
