            ...
            <div className="flex w-full lg:w-1/2 flex-col justify-center items-center bg-white px-6 py-12 sm:px-12 lg:px-24">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center space-y-2">
                        <h2 className="text-3xl font-semibold tracking-tight text-[#0B1437]">
                            Create an account
                        </h2>
                        <p className="text-sm text-slate-500 font-medium">
                            Sign up for a free merchant dashboard to get started.
                        </p>
                    </div>
                        ...
                        <div className="space-y-5 rounded-md">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input 
                                    ...
                                    autoComplete="name" 
                                    required 
                                    className="bg-slate-50 border-slate-200 focus:border-[#F97316] focus:ring-[#F97316]/20 text-slate-900 placeholder:text-slate-400 rounded-xl h-12 px-4 shadow-sm font-normal placeholder:font-normal"
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    <Input 
                                        ...
                                        required 
                                        className="bg-slate-50 border-slate-200 focus:border-[#F97316] focus:ring-[#F97316]/20 text-slate-900 placeholder:text-slate-400 rounded-xl h-12 px-4 shadow-sm pr-10 font-normal placeholder:font-normal"
                    ...
                    <div className="mt-8">
                        ...
                        <div className="mt-6 text-center text-sm text-slate-500">
                            ...
                            <Link href="/login" className="font-bold text-[#3A57FC] hover:text-[#2563EB] transition-colors">
                                Sign in
                            </Link>
                        </div>
