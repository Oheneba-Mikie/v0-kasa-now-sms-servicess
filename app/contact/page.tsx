                ...
                <div className="container mx-auto max-w-7xl px-4 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                        ...
                        <div className="space-y-12">
                            ...
                            >
                                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 tracking-tight">Reach us across all channels</h2>
                                ...
                                {contactMethods.map((method, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="flex items-center gap-2 text-[10px] font-bold uppercase text-slate-400 tracking-[0.2em]">
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    <h4 className="font-bold text-2xl tracking-tight text-white mb-1">Developer API Ready?</h4>
                                    <p className="text-slate-400 font-medium text-sm leading-relaxed">
                                        Our technical guides are designed to get you sending in milliseconds. 
                                        <br /> 
                                        <Link href="/docs" className="text-[#60A5FA] font-bold hover:underline inline-flex items-center gap-1 cursor-pointer mt-2 text-base">
                        ...
                        >
                            ...
                            <div className="text-center mb-12">
                                <h3 className="text-3xl font-bold text-gray-900 mb-4 tracking-tight">Ready to integrate?</h3>
                            ...
                            {!submitted ? (
                                    ...
                                    >
                                        ...
                                        <motion.div variants={itemVariants}>
                                            <Button 
                                                ...
                                                className="w-full h-20 bg-[#3A57FC] hover:bg-[#2D46C7] text-white font-bold rounded-2xl text-lg shadow-2xl shadow-[#3A57FC]/40 transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3 border-none group"
                                            >
                                                {isSubmitting ? (
                                ...
                                >
                                    ...
                                    <div className="space-y-4 text-center">
                                        <h4 className="text-3xl font-bold text-gray-900">Message Received!</h4>
                                        <p className="text-slate-500 font-medium">Thank you for reaching out. <br />Our team is currently reviewing your inquiry.</p>
                                    </div>
                                    <Button onClick={() => setSubmitted(false)} variant="ghost" className="rounded-xl text-[#3A57FC] hover:text-[#2D46C7] font-bold hover:bg-transparent">Send another message</Button>
                                </motion.div>
                            )}
                        </motion.div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-12 text-center">
                        {[
                            ...
                            >
                                ...
                                <div className="text-[10px] font-bold text-[#3A57FC] uppercase tracking-[0.2em]">{stat.label}</div>
