...
export default function WaitlistPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-center items-center overflow-hidden bg-[#24367A] font-sans">
            ...
            >
                {successMessage ? (
                    <div className="text-center py-8">
                        ...
                        <h3 className={`text-2xl font-extrabold mb-3 tracking-tight ${isNewUser ? 'text-green-700' : 'text-blue-700'}`}>
                    ...
                    <>
                        <div className="text-center mb-10">
                            <h2 className="text-3xl font-extrabold text-[#0B1437] tracking-tight mb-3">
                                Get Early Access
                            </h2>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className="h-14 bg-slate-50 border-slate-200 text-base text-slate-900 focus:border-[#F97316] focus:ring-[#F97316]/20 rounded-xl px-4 shadow-sm placeholder:text-slate-400"
                                    required
                                    value={email}
